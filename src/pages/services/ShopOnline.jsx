...
const ShopOnline = () => {
  ...
  const pageContent = {
    title: t.shopOnlineTitle || "Shop Online Locally and Globally",
    subtitle: t.shopOnlineSubtitle || "Buy What You Love, Anywhere",
    body: t.shopOnlineBody || "Use your Mikaty card to shop on your favorite local and international websites. Enjoy secure checkout and real-time tracking of your spending.",
    features: [
      t.shopOnlineFeature1 || "Shop on e-commerce sites worldwide",
      t.shopOnlineFeature2 || "Works for digital subscriptions and services",
      t.shopOnlineFeature3 || "Real-time transaction notifications",
    ],
    footerLine: t.shopOnlineFooterLine || "Freedom to shop, control to spend.",
  };
