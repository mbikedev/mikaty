...
const PayInStores = () => {
  ...
  const pageContent = {
    title: t.payInStoresTitle || "Pay in Stores",
    subtitle: t.payInStoresSubtitle || "Tap, Pay, Done",
    body: t.payInStoresBody || "Use your Mikaty digital card at physical retail locations that accept contactless payments. Just tap your phone or device — no cash or physical card needed.",
    features: [
      t.payInStoresFeature1 || "NFC tap-to-pay enabled",
      t.payInStoresFeature2 || "Works with smartphones and wearables",
      t.payInStoresFeature3 || "Fast and secure checkout experience",
    ],
    footerLine: t.payInStoresFooterLine || "Skip the queue, tap and go.",
  };
