...
const ZeroCostTransfers = () => {
  const { translations: t } = useLanguage();

  const pageContent = {
    title: t.zeroCostTransfersTitle || "0 Cost Transfers to Mikaty Users",
    subtitle: t.zeroCostTransfersSubtitle || "Send Money, Not Fees",
    body: t.zeroCostTransfersBody || "Send money to friends, family, or anyone in the Mikaty network for free. With our peer-to-peer (P2P) transfers, you can move funds instantly—at zero cost.",
    features: [
      t.zeroCostTransfersFeature1 || "Unlimited free transfers",
      t.zeroCostTransfersFeature2 || "Instant delivery",
      t.zeroCostTransfersFeature3 || "Ideal for splitting bills, group purchases, and more",
    ],
    footerLine: t.zeroCostTransfersFooterLine || "Because every cent should go where it matters.",
  };
...
export default ZeroCostTransfers;