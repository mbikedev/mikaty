                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($currentUser['username']); ?>&background=0D6EFD&color=fff&size=100" 
                                 alt="<?php echo htmlspecialchars($currentUser['username']); ?>'s Profile" 
                                 class="profile-image">
                        </div>
